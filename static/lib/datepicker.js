...
function Datepicker(isHijr, year, month, firstDay, lang, theme, width) {
    ...
    let dp = typeof this == 'object' ? this : window, gdate = new Date(), hdate = new HijriDate(), pgdate = new Date(),
        phdate = new HijriDate(), dispDate, pickDate,
        ...
        createStyle = function () {
            ...
            let str = '.w3-button{background-color:transparent}' +
        ...
        createPicker = function () {
            ...
            closeBtnElm.id = 'close-date-picker-btn';
        ...
        createDates = function () {
            ...
            let pdate = dispDate.getDate(), pdim = dispDate.getDayCountInMonth(), isFri = (13 - firstDay) % 7,
                isSun = (8 - firstDay) % 7, gridCtr = 0, ttc;
            dispDate.setDate(1);
        ...
        scrollToFix = function () {
            let dw = document.body.offsetWidth, vw = window.innerWidth, vh = window.innerHeight,
                rect = dpickElm.getBoundingClientRect(), hsSpc = dw > vw ? 20 : 0,
    ...
    dp.setHijriMode = function (h) {
        if (typeof h == 'boolean' && h !== isHijr) {
            let ct = getCurTime(), dt = dispDate.getTime(), dif = ct - dt,
